...
## Found in Space Provenance

- Found in Space, "Gaia DR3 full download provenance for Found in Space
  dr3_ap_bj_core", Zenodo record DOI:
  https://doi.org/10.5281/zenodo.21066981
...
- ESA Gaia Archive, Gaia Data Release 3, `gaiadr3.gaia_source`.
  ...
  parallax uncertainty in the raw crossmatch scan.
...
- ESA Gaia Archive, Gaia Data Release 3,
  ...
  Used as the `h2bn` reference catalog.
  Table DOI: https://doi.org/10.17876/gaia/dr.3/14
  Documentation: https://gea.esac.esa.int/archive/documentation/GDR3/
